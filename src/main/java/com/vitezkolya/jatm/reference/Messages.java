package com.vitezkolya.jatm.reference;
...
public class Messages {
	...
	public static class Configuration {
		...
		public static final String ORE_MIN_HEIGHT = "MinHeight";
		public static final String ORE_MIN_HEIGHT_LABEL = "min.height.label";
		public static final String ORE_MIN_HEIGHT_COMMENT = "min.height.comment";
		public static final String ORE_MAX_HEIGHT = "MaxHeight";
		...
		public static final String ORE_DIMENSION_LIST = "DimensionList";
		public static final String ORE_DIMENSION_LIST_LABEL = "dimension.list.label";
		public static final String ORE_DIMENSION_LIST_COMMENT = "dimension.list.comment";
	}
}
